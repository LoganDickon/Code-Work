...
def hide_screens():
	...
	signup_screen_Frame.pack_forget()
...
def select_page():
	...
	"""selection_one_Frame = Frame(select_screen_Frame, width=(width * .4), height=(height * .4), style='login.TFrame')
	selection_one_Frame.place(x=(width * .075), y=(height * .075))
	my_img = ImageTk.PhotoImage(Image.open('orange.png'))
	my_label = Label(selection_one_Frame, image=my_img)
	my_label.pack()"""

	selection_one_Frame = Canvas(select_screen_Frame, width=(width * .4), height=(height * .4), style='login.TFrame')
	selection_one_Frame.place(x=(width * .075), y=(height * .075))
	my_img = ImageTk.PhotoImage(Image.open('orange.png'))
	my_label = Label(selection_one_Frame, image=my_img)
	my_label.pack()

	selection_two_Frame = Frame(select_screen_Frame, width=(width * .4), height=(height * .4), style='login.TFrame')
	selection_two_Frame.place(x=(width * .525), y=(height * .075))

	selection_three_Frame = Frame(select_screen_Frame, width=(width * .4), height=(height * .4), style='login.TFrame')
	selection_three_Frame.place(x=(width * .075), y=(height * .525))

	selection_four_Frame = Frame(select_screen_Frame, width=(width * .4), height=(height * .4), style='login.TFrame')
	selection_four_Frame.place(x=(width * .525), y=(height * .525))
...
def signup_page():
	...
	signup_admin_Entry.place(x=(width*.315), y=(height*.65))
	admin_Label = Label(signup_screen_Frame, text='Admin Key', style="back.TLabel")
	admin_Label.place(x=(width*.365), y=(height*.62))
	...
	signup_lname_Entry.place(x=(width*.5), y=(height*.4))
	lname_Label = Label(signup_screen_Frame, text='Last Name', style="back.TLabel")
	lname_Label.place(x=(width*.55), y=(height*.37))
...
def login_page():
	...
	login_Frame.place(x=(width*.37), y=(height*.24))
	
	login_Label = Label(login_screen_Frame, text='Sign In', font=('Arial', 32), style='login.TLabel')
	login_Label.place(x=(width*.4725), y=(height*.32))
	...
	login_user_Label.place(x=(width*.4825), y=(height*.42))
...
def Main_Window():
	...
	# Configure Styles
	style = Style(root)
	style.configure('login.TButton', font=('arial', 16), background='white', foreground='red')
	style.configure('global.TButton', width=3.75, font=('arial', 18))
	...
	quit_Button = Button(root, text=' X ', command=quit, style='global.TButton')
	quit_Button.place(x=(width*.9795),y=(0))

	minimize_Button = Button(root, text=' - ', command=root.iconify, style='global.TButton')
