...
public:
  AllSensors_DLHR_L10D_6(TwoWire *bus) : AllSensors_DLHR(bus, AllSensors_DLHR::SensorType::DIFFERENTIAL, AllSensors_DLHR::SensorResolution::RESOLUTION_18_BITS, 10.0) {}
};
