  ...
  // Run Main Program or Validate Sensors
    ...
    if (flowSensor.getDifferentialPressure() && diffSensor.pressure) {
      // LPM & Flow Pressure
        ...
        LPM = ((((-0.0025 * (flowPressure * flowPressure)) + (1.0761 * flowPressure) + 40.244)));
        HMI.setCursor(65, 90);
      ...
      // Filter Test Procedure
        if (LPM < 83.47) {                                                       
          ...
          if ((StartTimer == false) && (LPM > 86.53)) {
            StartTimer = true;
            fanSpeed = startSpeed;
            analogWrite(PWM, fanSpeed);
          }
          if ((StartTimer == false) && ((LPM >= 83.47) && (LPM <= 86.53))) {
            ...
            while (TestCycles == 20) {
              ...
              fanSpeed += 1.5;                                                          
              analogWrite(PWM, fanSpeed);                                                 
          } if ((StartTimer == false) && (LPM > 80) && (LPM <= 83.47) && (fanSpeed < 204)) {          
              fanSpeed += 1;                                                            
              analogWrite(PWM, fanSpeed);                                               
          } if ((StartTimer == false) && (LPM >= 86.53) && (fanSpeed < 204)) {                      
              fanSpeed -= 1;                                                            
              analogWrite(PWM, fanSpeed);                                               
          } while (fanSpeed >= 204) {
